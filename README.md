...
Flood Forecasting System Overview
...
Website
🌐 Visit the interactive web-based flood forecasting platform here:
🔗 SEAS Flood Forecasting Web Application

The website visualizes real-time river flow predictions for the Long Dai River, integrates meteorological inputs, and demonstrates how AI models can assist in early warning systems for disaster management. The online interface was built for accessibility and educational purposes to showcase the model’s deployment and results.
